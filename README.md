...
> 纯 C3 语言编写，单文件集成、零外部依赖、开箱即用的轻量化数学工具库
> 
>         涵盖基础数值运算、数组处理、数论算法等常用功能，适配学习实操、课程作业、小型项目快速开发。
> 
> 
...
- **🧩 零依赖无侵入**：纯原生 C3 语法实现，不依赖任何第三方库，不占用额外项目资源

- **🧮 功能全覆盖**：囊括基础数值运算、数组工具、数论算法、序列计算、数值约束等高频功能

- **🔍 代码易读易改**：函数逻辑简洁清晰，附带完整注释，新手也能轻松理解、二次修改
...
将项目内的 `math\.c3` 文件，直接复制到你的 C3 项目根目录即可。

### 3\. 模块引入

在需要调用函数的 C3 文件顶部，导入 math 模块：
